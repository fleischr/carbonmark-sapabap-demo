CLASS zcl_prvd_eco_demo_sflight DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_prvd_eco_demo_sflight IMPLEMENTATION.
  ...
  METHOD zif_prvd_eco_demo_0901~aggregate_sflight_emissions.
    ...
    CONSTANTS: c_carbon_per_seat TYPE zprvd_eco_carbontonne VALUE '0.001'.
