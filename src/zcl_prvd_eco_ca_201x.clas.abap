CLASS zcl_prvd_eco_ca_201x DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    INTERFACES zif_prvd_eco_ca_2011 .
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
CLASS zcl_prvd_eco_ca_201x IMPLEMENTATION.
...
*        rs_carbon_aggregate =
  ...
  METHOD zif_prvd_eco_ca_2011~create.
  ENDMETHOD.


  METHOD zif_prvd_eco_ca_2011~delete.
  ENDMETHOD.


  METHOD zif_prvd_eco_ca_2011~query.
  ENDMETHOD.


  METHOD zif_prvd_eco_ca_2011~read.
  ENDMETHOD.


  METHOD zif_prvd_eco_ca_2011~update.
  ENDMETHOD.
ENDCLASS.
