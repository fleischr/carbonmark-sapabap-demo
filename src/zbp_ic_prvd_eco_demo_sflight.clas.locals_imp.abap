CLASS lhc_ZIC_PRVD_ECO_DEMO_SFLIGHT DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.

    METHODS get_instance_features FOR INSTANCE FEATURES
      IMPORTING keys REQUEST requested_features FOR zic_prvd_eco_demo_SFLIGHT RESULT result.

    METHODS get_instance_authorizations FOR INSTANCE AUTHORIZATION
      IMPORTING keys REQUEST requested_authorizations FOR zic_prvd_eco_demo_SFLIGHT RESULT result.

    METHODS aggregateCarbon FOR MODIFY
      IMPORTING keys FOR ACTION zic_prvd_eco_demo_SFLIGHT~aggregateCarbon RESULT result.

    METHODS proofOfAtomicOffset FOR MODIFY
      IMPORTING keys FOR ACTION zic_prvd_eco_demo_SFLIGHT~proofOfAtomicOffset RESULT result.

    METHODS retireCarbon FOR MODIFY
      IMPORTING keys FOR ACTION zic_prvd_eco_demo_SFLIGHT~retireCarbon RESULT result.

ENDCLASS.

CLASS lhc_ZIC_PRVD_ECO_DEMO_SFLIGHT IMPLEMENTATION.
...
*    MODIFY ENTITIES OF zic_prvd_eco_demo_SFLIGHT IN LOCAL MODE ENTITY zic_prvd_eco_demo_SFLIGHT
...
*     "Read changed data for action result
    READ ENTITIES OF zic_prvd_eco_demo_SFLIGHT IN LOCAL MODE
      ENTITY zic_prvd_eco_demo_SFLIGHT
      ALL FIELDS WITH
      CORRESPONDING #( keys )
      RESULT DATA(flights).
  ...
  METHOD retireCarbon.
    ...
    ls_carbon_retirement = lcl_provide_eco_sflightdemo->zif_prvd_eco_demo_0901~retire_carbon_from_aggregate( is_common_aggregate  = ls_carbon_aggregate
                                                                                                             ...
                                                                                                             iv_beneficiary_string = 'Provide SFLIGHT Fiori demo'
                                                                                                             iv_retirement_message = 'Provide SFLIGHT Fiori demo.'  ).
